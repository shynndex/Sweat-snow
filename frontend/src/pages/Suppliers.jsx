...
const Suppliers = () => {
  const data = [
    { id: 1, code: 'NCC-1', name: 'Công ty TNHH ABC', phone: '0123456789', address: '123 Đường A, Quận 1, TP.HCM', status: 'Hoạt động' },
    { id: 2, code: 'NCC-2', name: 'Công ty CP XYZ', phone: '0987654321', address: '456 Đường B, Quận 2, TP.HCM', status: 'Hoạt động' },
    { id: 3, code: 'NCC-3', name: 'Công ty TNHH EFG', phone: '0112233445', address: '789 Đường C, Quận 3, TP.HCM', status: 'Không hoạt động' },
  ];
        ...
        <table className="min-w-full border border-gray-300">
          <thead>
            <tr className="bg-[#E6C87A]">
              ...
              <th className="py-2 px-4 text-left font-bold">Số điện thoại</th>
              <th className="py-2 px-4 text-left font-bold">Địa chỉ</th>
