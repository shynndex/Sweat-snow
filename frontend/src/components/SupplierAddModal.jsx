...
const SupplierAddModal = ({ open, onOpenChange, onSave }) => {
    const [formData, setFormData] = useState({
        ...
        address: '',
        note: '',
        status: true, // true = Hoạt động, false = Không hoạt động
    });
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[520px] max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    <DialogTitle className="text-lg font-semibold">Thêm mới nhà cung cấp</DialogTitle>
                </DialogHeader>
